    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="<?= base_url("Home/presensi") ?>">
                    <i class="fas fa-sign-in-alt fa-fw mr-2 text-gray-400"></i>
                    Rekam Kehadiran
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?= base_url("Home/kehadiran") ?>">
                    <i class="fas fa-clipboard-check fa-sm fa-fw mr-2 text-gray-400"></i>
                    Daftar Kehadiran
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?= base_url("laporan_kinerja/index") ?>">
